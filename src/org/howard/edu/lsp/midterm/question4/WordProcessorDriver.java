...
public class WordProcessorDriver {
    public static void main(String[] args) {
        ...
        // Test case 3: Sentence with multiple longest words of equal length
        WordProcessor wp3 = new WordProcessor("This sentence contains two words of equal length.");
        List<String> longestWords3 = wp3.findLongestWords();
        System.out.println("Test 3 - Longest words: " + longestWords3);  
        // Expected Output: [contains, length]
        ...
        // Test case 5: Sentence with multiple longest words
        WordProcessor wp5 = new WordProcessor("This is a simple example with several words having equal lengths.");
        List<String> longestWords5 = wp5.findLongestWords();
        System.out.println("Test 5 - Longest words: " + longestWords5);  
        // Expected Output: [example, several, having, equal, lengths]
    }
}
